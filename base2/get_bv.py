...
for k in range(1, 34):
    h = GetHTML('https://search.bilibili.com/all?keyword=%E9%BC%A0%E5%A4%B4%E9%B8%AD%E8%84%96&from_source=webtop_search&spm_id_from=333.1007&search_source=5&page={}'.format(k))
    bvs = GetInfo(h)
    for bv in bvs:
        print(bv[31:43])